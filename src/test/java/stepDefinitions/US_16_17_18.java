...
//<US_17>
    ...
    public void ramazanNameDescriptionPriceDefaultMinValueDefaultMaxValueGirer() {
        medunna_06Page.nameTestItems.sendKeys("rruuu");
    ...
    public void ramazanDeleteIkonunaTiklayarakBirTestOgeleriniSiler() {
        ...
        medunna_06Page.deleteOnayTestITemss.click();
...
ReusableMethods.waitFor(2);
        ...
        Assert.assertTrue(medunna_06Page.fotodosyaPhysician.isDisplayed());
...
medunna_06Page.createNewRoom.click();
    ...
    public void ramazanKullaniciRoomNumberDoldururVe() {
        medunna_06Page.roomNumberRoom.sendKeys("2598888");
...
medunna_06Page.popUpMessageDeleteRoom.isDisplayed();
    }
